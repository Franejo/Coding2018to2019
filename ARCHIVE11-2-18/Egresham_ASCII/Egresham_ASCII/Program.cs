    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            do
            {
                ...
                Console.WriteLine("If you would like Right Triangle number 2, select 5. NOT CURRENTLY WORKING");
                Console.WriteLine("If you would like a pyramid, select 6 NOT CURRENTLY WORKING");
                Console.WriteLine("If you would like special number 1, select 7");
                Console.WriteLine("If you would like special number 2, select 8 NOT CURRENTLY WORKING");
                Console.WriteLine("If you would like special number 3, select 9 NOT CURRENTLY WORKING");
