...
namespace palindrome
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.Write("Enter something for to check that is it palindrome :");// asks for a palindrome
            string palindrome = Console.ReadLine(); // declares a string and makes the input the string
